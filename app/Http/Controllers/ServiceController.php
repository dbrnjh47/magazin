...
// $this->settings->mail;
        mail('satanova.1987@gmail.com', 'Оформление услуги! | '.$_SERVER['SERVER_NAME'], "
Имя: ".$r->name."\n
Номер: ".$r->phone."\n
Почта: ".$r->mail."\n
Услуга: ".$r->lot."\n
...
");
    ...
    public function call_order(Request $r)
    {
        ...
        mail('satanova.1987@gmail.com', 'Заказ звонка! | '.$_SERVER['SERVER_NAME'], "
Номер: ".$r->phone."\n
Услуга: ".$r->lot."\n
Количество: ".$r->kol."\n
Ссылка: ".$_SERVER['SERVER_NAME'].'/service/lot/'.$r->lot_id."
