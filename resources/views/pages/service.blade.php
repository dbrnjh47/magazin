...
<span> <a href="/">Главная</a>
    ...
    &gt;&gt; <a href="/catalog/{{$service->catalog_id}}">Опоры трубопроводов</a>
                                ...
                                <div class="single-product">
                                    <div class="col-md-3 col-sm-4 col-xs-12">
                                        <div class="product-img">
                                            <img class="primary-img" src="{{$service->img}}" alt="{{$service->name}}">
                                        </div>
                                    </div>
                                    <div class="col-md-9 col-sm-8 col-xs-12">
                                        <div class="product-description">
                                            ...
                                            <p>Мы готовы поставить любые виды изоляционных материалов в кротчайшие сроки и по доступным ценам. Наша команда готова к заказам</p>
                                            <p></p>
			...
			columns: [
                ...
                { data: null, searchable: false, orderable: false,
					render: function (data, type, row) {
						return `
						<a href="/service/lot/`+ row[row.length - 1] +`" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Перейти"><i class="la la-edit"></i></a>
